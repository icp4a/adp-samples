 ...
 * Automated Document Processing Webhook Receiver application. In a production
 * environment, a different approach should be used to store, encrypt, and 
...
public class CSServerInfo
{
    ...
    /** Content Services GraphQL API URL */
    public static final String CS_SERVER_CONTENT_DOWNLOAD_URL;

    /** Automated Document Processing Webhook Receiver URL. */
    public static final String WEBHOOK_RECEIVER_URL;
    
    /** Content Services GraphQL Domain */
    public static final String CS_SERVER_GRAPHQL_DOMAIN;
    ...
    static
    {
        ...
        InputStream in = cl.getResourceAsStream("CSServerInfo.properties");
        ...
        {
            Logger.error("CSServerInfo: ", "CSServerInfo, IOException loading CSServerInfo.properties", e);
        }

        // Load constants from CS_SERVER_INFO
        CS_SERVER_GRAPHQL_URL = getString("CS_SERVER_GRAPHQL_URL");
        CS_SERVER_CONTENT_DOWNLOAD_URL = getString("CS_SERVER_CONTENT_DOWNLOAD_URL");
        WEBHOOK_RECEIVER_URL = getString("WEBHOOK_RECEIVER_URL");
        CS_SERVER_GRAPHQL_DOMAIN = getString("CS_SERVER_GRAPHQL_DOMAIN");
    ...
    public static String getString(String key)
    {
        ...
        {
            Logger.error("CSServerInfo.getString: ", "IOException loading CSServerInfo.properties", e);
        	throw e;
//            return null;
        }
    }
